...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i].querySelector('[data-slide="next"]')).click(e => {
      ...
      dots.forEach(dot => Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(dot).removeClass('active'));
      Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(dots[slideIndex]).addClass('active');
    });
    ...
    const sliderId = Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i]).getAttr('id');
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(`#${sliderId} .carousel-indicators li`).click(e => {
      const slideTo = Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(e.target).getAttr('data-slide-to');
      slideIndex = slideTo;
